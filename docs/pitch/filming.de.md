...
Für beide Sprechtexte derselbe Plan. Alles hier lässt sich mit zwei Geräten und einem
Stativ aufnehmen; nichts davon braucht einen Schnittplatz mit mehreren Spuren.

## Was vorher eingestellt wird

- **Technische Ansicht aus.** Der Pitch zeigt die einfache Ansicht — die technische ist
  für Entwickler und macht das Bild unruhig. (Für den Fachtext siehe unten.)
- **Kurzcode an**, wenn du das Scannen zeigst. Sonst sind es fünf animierte Bilder statt
  eines stehenden Codes, und die Kamera braucht sichtbar länger. Der Haken sitzt unter
...
Dieselben Bilder, zwei Ergänzungen:

- Bei „Wir haben ihn gelöscht" das **Netzwerk-Panel der Entwicklerwerkzeuge** einblenden,
  während die Verbindung zustande kommt. Man sieht: keine Anfrage an irgendeinen
  Signalisierungsdienst. Das ist der Beleg, den ein Fachpublikum sehen will.
- Bei „Ehrlich bleiben" die STUN-Anfrage im selben Panel zeigen. Wer die Ehrlichkeit
  behauptet, soll sie auch vorzeigen.

## Ein Detail, das selbst ein Argument ist

**Der Code im Video ist wertlos, sobald ihn jemand sieht.** Eine Einladung verfällt nach
zehn Minuten. Du kannst also einen echten Code filmen, ohne etwas zu verstecken — und
genau das ist erwähnenswert, falls jemand in den Kommentaren fragt: Wer das Video anhält
